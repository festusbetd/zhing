...
ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.AirtimeList);

        String[] airtime = getResources().getStringArray(R.array.airtime_array);
        //Row layout defined by Android: android.R.layout.simple_list_item_1
        listView.setAdapter(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_activated_1, airtime));
